...
public class AdvancedTrader extends Trader {
	...
	public Trade[] suggestTrades() {
		...
		Trade trade1 = new Trade(new Integer(623), "Trit");
		...
		ArrayList<Integer> stableTrendLength = new ArrayList<Integer>();
		...
		TreeMap<String, BigDecimal[]> historicalData = marketData.crestData.get(new Integer(623));
